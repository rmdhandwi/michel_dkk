    ...
    <div class="card-body darsip">
        <div class="table-responsive">
            ...
            <div class="d-flex mt-3 justify-content-between">
                <button class="btn btn-primary" data-toogle="modal" data-target="#Tuser" style="border-radius: 6px;">Tambah Kategori</button>
            </div>
        </div>
    </div>
</div>
...
<!-- Modal -->
<div id="Tuser" class="modal fade" tabindex="-1">
